...
* Azure与阿里云提供的服务有哪些不同
 ...
 Azure与阿里云各别设计了云端平台与开发了云服务，因此在各个主要的面向中都有一些差距。
...
虽然两个平台都提供相似的功能，在资源的使用与管理上却有不同的设计。在许多的功能与解决方案设计中，无法有完全一对一的关系，有些服务也只在一个平台中提供。请参阅[Azure与阿里云的服务对照表]()。
...
请参与[Azure与阿里云的服务对照表]()，了解两个平台完整的服务对应关系。
